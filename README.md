</p><h1 align="center">👋 Hi, I'm Luiza Santos</h1>
...
<p align="center">
  <!-- LinkedIn -->
  <a href="https://www.linkedin.com/in/luizataynara/" target="_blank" rel="noopener noreferrer">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white"/>
  </a> &nbsp;
  
  
  <!-- Email -->
  <a href="mailto:taynaraluiza@gmail.com" target="_blank" rel="noopener noreferrer">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white"/>
  </a> &nbsp;
  

  <!-- Discord -->
  <a href="https://discordapp.com/users/lluiza" target="_blank" rel="noopener noreferrer">
    <img src="https://img.shields.io/badge/Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white"/>
  </a> &nbsp;

  <!-- GitHub -->
  <a href="https://github.com/LuizaTaynara" target="_blank" rel="noopener noreferrer">
...
✦ Business Administration graduate with previous experience in technical support and currently transitioning into Quality Assurance. Completed intensive training and gained hands-on experience in manual and automated testing for web, mobile, and API applications, using tools such as DevTools, Android Studio, Postman, SQL, Python, Selenium WebDriver, and Git/GitHub. Analytical, organized, and solution-oriented professional with strong attention to detail and a fast-learning mindset. Seeking my first QA opportunity to contribute to product quality while continuing to grow and develop within the field.

✦ Formada em Administração de Empresas, com experiência em suporte técnico e transição de carreira para Quality Assurance. Formação intensiva e prática em testes manuais e automatizados de aplicações web, mobile e APIs, utilizando DevTools, Android Studio, Postman, SQL, Python, Selenium WebDriver e Git/GitHub. Perfil analítico, organizado e orientado à resolução de problemas. Busco minha primeira oportunidade em QA para contribuir com a qualidade dos produtos e evoluir profissionalmente na área.
...
Verified request and response behavior, HTTP status codes, JSON payloads, business rules, input validation, and error handling. Applied API testing techniques to ensure compliance with requirements and documented defects through detailed bug reports in Jira.

**Skills:** API Testing • Postman • REST • HTTP • JSON • Request Validation • Response Validation • Error Handling • Test Design • Jira • Bug Reporting • Quality Assurance
...
Executed testing on an Android emulator, identified and documented defects in Jira, and verified application compliance with business requirements and user experience expectations.
...
Executed data aggregation, joins, filtering, and business rule validation to support troubleshooting, reporting accuracy, and backend quality assurance processes.

**Skills:** SQL • PostgreSQL • Database Testing • Data Validation • Linux • Log Analysis • Backend Testing • Business Rule Validation • Root Cause Analysis • Quality Assurance
...
**Skills:** Python • Selenium WebDriver • Pytest • Page Object Model (POM) • UI Automation • End-to-End Testing • Test Framework Design • Automated Testing • Git • Quality Assurance
...
Analyzed requirements, documented defects in Jira, and evaluated application behavior against business and functional specifications to ensure product quality across multiple platforms.
